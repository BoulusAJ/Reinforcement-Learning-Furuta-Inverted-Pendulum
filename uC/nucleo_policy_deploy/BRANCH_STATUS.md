...
limited the policy command to 0.5 A before adding the 0.0205 A offset; the final
4 A clamp was a separate last-resort bound, not the normal test command level.
