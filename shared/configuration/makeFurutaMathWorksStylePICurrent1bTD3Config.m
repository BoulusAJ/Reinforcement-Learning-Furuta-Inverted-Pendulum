...
modelDir = fullfile(cfg.ProjectRoot, "approaches", "td3_swingup_balance", "models");
cfg.Model.TrainingFile = fullfile(modelDir, cfg.Model.TrainingName + ".slx");
cfg.Model.EvaluationFile = fullfile(modelDir, cfg.Model.EvaluationName + ".slx");
