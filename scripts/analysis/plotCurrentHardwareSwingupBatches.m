...
testRoot = fullfile(paths.ResultsRoot, "model_vs_hardware", ...
...
% batches = localBatchDefinitions(paths.ResultsRoot);
...
function batches = localBatchDefinitions(resultsRoot)
batches = [
    struct( ...
        "Name", "scale0p4_lim4a", ...
        "Root", fullfile(resultsRoot, "model_vs_hardware", ...
