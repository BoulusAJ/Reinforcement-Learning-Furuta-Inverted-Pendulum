...
drehpendelRoot = fullfile(repoRoot, "references", "drehpendel");
drehpendelMatlabDir = fullfile(drehpendelRoot, "matlab");
drehpendelSldrtDir = fullfile(drehpendelMatlabDir, "dev", "inv_rot_pen_sldrt");
drehpendelIirDir = fullfile(drehpendelMatlabDir, "dev", "iirfilter");
drehpendelSerialStreamDir = fullfile(drehpendelMatlabDir, "dev", "serial_stream");

addpath(scriptDir);
addpath(drehpendelMatlabDir);
...
cfg.Reference.Root = fullfile(repoRoot, "references", "drehpendel");
cfg.Reference.LabModelDir = drehpendelMatlabDir;
cfg.Reference.CourseLabDir = drehpendelMatlabDir;
...
if options.LoadModel
    modelPath = fullfile(scriptDir, options.ModelName + ".slx");
