function cfg = makeFurutaDetailed1c500HzTheta1OffsetScratchTD3Config()
%MAKEFURUTADETAILED1C500HZTHETA1OFFSETSCRATCHTD3CONFIG
% Scratch 500 Hz TD3 run on the 1c detailed model near the observed theta1
% offset balance region. This tests whether the detailed plant/reward can
% learn near-upright balance without inheriting the original 500Hz_long agent.
%
...
cfg.Training.Reset.Name = "detailed_1c_theta1_offset_scratch";
...
cfg.Training.SavePrefix = "FurutaTD3_mathworks_style_pi_current_1c_500hz_theta1_offset_scratch";
cfg.Training.RunName = "run_" + string(datetime("now", "Format", "yyyyMMdd_HHmmss")) + "_td3_mathworks_style_pi_current_1c_500hz_theta1_offset_scratch";
