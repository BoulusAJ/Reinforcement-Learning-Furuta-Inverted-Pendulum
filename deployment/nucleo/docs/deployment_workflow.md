...
```text
approaches/td3_swingup_balance/agents/FurutaTD3_500Hz_long_final.mat
```

and writes:

```text
deployment/nucleo/generated/td3_swingup_balance/rl_policy_weights.h
deployment/nucleo/generated/td3_swingup_balance/actor_export_nucleo.mat
```
